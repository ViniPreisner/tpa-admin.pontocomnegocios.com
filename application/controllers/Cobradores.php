...
class Cobradores extends MY_Controller {
	...
	function __construct()
	{
        ...
        $this->load->model('cobradores_model', 'cm');
	...
	public function index($page = false)
	{
        ...
        if ($total_records > 0) {
            ...
            $this->data['pagination'] = $this->paginationLinks($total_records,$limit_per_page,'cobradores');    
        } else {
		...
		$this->data['content'] = $this->load->view('content/cobradores-lista', $this->data, TRUE);

		$this->data['footer'] = $this->load->view('footer', $this->data, TRUE);
		$this->data['extra_scripts'] = array($this->load->view('js/cobradores', NULL, TRUE));
	...
	public function incluir()
	{
		...
		$this->data['content'] = $this->load->view('content/cobradores-form', $this->data, TRUE);
