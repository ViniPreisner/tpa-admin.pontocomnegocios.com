...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">Novo cobrador</h3></div>
            <div class="panel-body">
                <form role="form" method="post" action="<?=base_url()?>cobradores/post">
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <label for="name">Nome do cobrador</label>
